...
import ChartCard from "../../../Agency/comp/ChartCard"; // Reusing ChartCard from your project
...
export interface TpTpTopFiveProps {
  ...
  from: Date | null;
  to: Date | null;
  statuses: ("hit" | "no_hit" | "own_state" | "inter_state")[];
}

type ChartDatum = { state: string; value: number };

const VALID_STATUSES = ["hit", "no_hit", "own_state", "inter_state"] as const;
